    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.numCards}>
          Number of cards: {decks[deckId] && decks[deckId].questions.length}
        </Text>
        <DeleteDeckBtn id={deckId} font = {22} parent = 'DeckView'/>
        <TouchableOpacity
          style={styles.addBtn}
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("Quiz details", { deckId })}
        >
